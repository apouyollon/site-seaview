...
try {
    $pdo = new PDO('mysql:host=localhost;dbname=Devis', 'nom_utilisateur', 'mot_de_passe');
    $pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);

    // Préparez la requête d'insertion des données dans la table correspondante
    $stmt = $pdo->prepare('INSERT INTO VotreTable (nomSociete, prenom, nom, telephone, email, description, nomFichier, fichier) VALUES (?, ?, ?, ?, ?, ?, ?, ?)');
